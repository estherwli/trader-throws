  ...
  in_bin(bin_num, ball_y, ball_z) {
    ...
    {   
          if (this.challenge)
          {
            ...
            if(!this.game_over && this.time < 16 && this.score >= 3)// this.score should be >= 30, I set this.score >= 3 for demo
            {
              this.game_end = true;
              this.reset_se();
              this.reset_bg();
          ...
          else
          {
            ...
            //play game ending sounds
            if(!this.game_over && this.time < 16 && this.life > 0 && this.score >= 3)// this.score should be >= 30, I set this.score >= 3 for demo
            {
              this.game_end = true;
              this.reset_se();
              this.reset_bg();
...
//     this.shapes.bin.draw(context, program_state, this.tr_bin2, this.materials.bin2);
    ...
    let messageModelTransform = this.initial_camera_location.times(Mat4.translation(-14,7.5,-15.5)) // [-11,5.5,-15] for scoreboard
      ...
      */
      ...
      if(this.game_over || (this.time >= 16 && this.score < 2 && !this.game_end && this.lives < 5))
      {
      ...
      //display Game Ending
      else if(!this.game_over && this.time > 15 && this.life > 0 && this.score > 2) //this.score should be over 30, I set this.score >= 1 for testing
      {
          this.shapes.plane.draw(context, program_state, tr_intro_pink, this.materials.pink_wall); 
          this.shapes.plane.draw(context, program_state, tr_intro_white, this.materials.white_wall);  
